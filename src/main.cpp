...
int main(int argc, char** argv)
{
    ...
    pid_para_cam_pitch->kp = 0.005;
    pid_para_cam_pitch->ki = 0.03;
    ...
    // pid_para_nozzle_pitch->kp = 0.06;//0.05;
    ...
    pid_para_cam_yaw->kp = 0.006;
    pid_para_cam_yaw->ki = 0.03;
    ...
    // pid_para_nozzle_yaw->kp = 0.07;//0.05;
